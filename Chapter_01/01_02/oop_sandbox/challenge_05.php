...
class Bicycle
{
    protected static $brandNew;
    protected static $modelNew;
    protected static $wheelsNew = 2;
    protected static $yearNew;
    //private static $description;
    protected static $weight_lbs_new  = 0.00;
    protected static $weight_kg_new = 0.00;

    public static $instance_count = 0;
    public static $CATEGORY = ["Road", "Mountain", "Hybrid", "City", "BMX"];

    public  static function create($brand, $model, $year)
    {
        static::$brandNew = $brand;
        static::$modelNew = $model;
        static::$yearNew = $year;

        static::$instance_count++;

        echo static::$brandNew . " " . static::$modelNew . " " . static::$yearNew . " " . static::$instance_count;
    }
...
Bicycle::create("BMX", "R7", 2024);
echo "<br>";
Unicycle::create("BMX", "R7", 2024);
echo "<br>";
Unicycle::create("BMX", "R7", 2024);
echo "<br>";
Bicycle::create("BMX", "R7", 2024);
